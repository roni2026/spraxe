...
export async function POST(req: Request) {
  ...
  // Same auth pattern as /api/cloudinary/sign: the browser sends its access
  // token as a Bearer header; a fresh server client cannot see the session
  // otherwise and would always return 401.
  try {
